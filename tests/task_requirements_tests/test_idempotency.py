...
def test_create_order_different_ts_same_body(client, clear_idempotency_set, mock_asyncio_sleep):
    payload = {
        "direction": "on-ramp",
        "pair": "USDT-USD",
        "amount": 100.0,
...
def test_create_order_same_ts_different_body(client, clear_idempotency_set, mock_asyncio_sleep):
    ts = "12345"
    # First request
